...
// ProtectedEndpoint represent protected end-point which can be reached
// only if user authenticated via 2FA method
...
func HomeHandler(w http.ResponseWriter, r *http.Request) {
	...
	// it should display SingIn form and provide link to SignUp page
	page := "Hello world"
	w.Write([]byte(page))
}

// SignUpHandler represents server sign up page
func SignUpHandler(w http.ResponseWriter, r *http.Request) {
	// TODO: create signup page
	// it should display SingUp form and once posted it should
	// redirect to /qr end-point
	page := "SignUp form should redirect to /qr end-point"
	w.Write([]byte(page))
}
